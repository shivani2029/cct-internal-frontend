...
import { deleteVendor, getAllVendor } from '@/services/vendor';
import EditVendorModel from '@/components/model/EditVendorModel';
  ...
  return (
    <>
      ...
      <div className="flex max-sm:flex-col flex-row w-full justify-between items-center py-7">
        <h1 className="text-xl font-semibold text-black">Vendor</h1>
        <Button
          type="button"
